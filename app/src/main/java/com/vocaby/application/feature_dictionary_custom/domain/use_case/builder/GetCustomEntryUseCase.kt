...
class GetCustomEntryUseCase(
    ...
    suspend operator fun invoke(userId: Int, entry: String): EntryModel {
        val data = customDictionaryRepository.getUserEntryData(userId, entry)
        return data ?: EntryModel(entry = entry)
    }
}