...
import com.vocaby.application.feature_save.domain.use_cases.collection.RemoveSaveCollectionItemUseCase
...
class SaveUseCases(
    ...
    val removeSaveCollectionItemUseCase: RemoveSaveCollectionItemUseCase
)